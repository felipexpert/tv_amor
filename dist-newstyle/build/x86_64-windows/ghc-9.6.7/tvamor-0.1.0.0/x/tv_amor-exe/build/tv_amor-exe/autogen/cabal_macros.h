...
/* package tvamor-0.1.0.0 */
#ifndef VERSION_tvamor
#define VERSION_tvamor "0.1.0.0"
#endif /* VERSION_tvamor */
#ifndef MIN_VERSION_tvamor
#define MIN_VERSION_tvamor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tvamor */
...
#define CURRENT_COMPONENT_ID "tvamor-0.1.0.0-inplace-tv_amor-exe"
